...
public class NotEnoughRunesPlugin extends Plugin
{
	...
	{
		log.info("Not Enough Runes started!");
	}

	@Override
	protected void shutDown() throws Exception
	{
		log.info("Not Enough Runes stopped!");
	}
	...
	public void onGameStateChanged(GameStateChanged gameStateChanged)
	{
		...
		{
			client.addChatMessage(ChatMessageType.GAMEMESSAGE, "", "Not Enough Runes says " + config.greeting(), null);
		}
	}
